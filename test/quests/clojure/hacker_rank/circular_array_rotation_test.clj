(ns quests.clojure.hacker-rank.circular-array-rotation-test
  (:require [clojure.test :refer :all]
            [quests.clojure.hacker-rank.circular-array-rotation :refer :all]))

(deftest a-test
  (testing
    (is (= [2 3 1] (circularArrayRotation [1 2 3] 2 [0 1 2])))
    ;solved but this is false data
    #_(is (= [20372
            35673
            58089
            73089
